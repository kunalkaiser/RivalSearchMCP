...
from rival_search_mcp.core.github_api import GitHubSearch
from rival_search_mcp.logging.logger import logger
from rival_search_mcp.utils.markdown_formatter import format_github_markdown
...
def register_github_tools(mcp: FastMCP):
    ...
    async def github_search(
        ...
        try:
            ...
            try:
                from rival_search_mcp.core.quality import assess_results
