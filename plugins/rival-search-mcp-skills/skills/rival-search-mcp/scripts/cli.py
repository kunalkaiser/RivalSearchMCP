...
9 tools for web search, social media, news, GitHub, content extraction,
...
app = cyclopts.App(
    name="rival-search",
    help="RivalSearchMCP CLI — Deep research and competitor analysis. 9 tools, no API keys required.",
)
